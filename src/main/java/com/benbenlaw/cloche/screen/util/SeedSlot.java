...
public class SeedSlot extends ResourceHandlerSlot {

    public SeedSlot(ResourceHandler<ItemResource> handler, IndexModifier<ItemResource> slotModifier, int handlerSlot, int xPosition, int yPosition) {
    ...
    public boolean mayPlace(ItemStack itemStack) {
        ...
        List<Ingredient> seeds = ClocheRecipeCache.getRecipes().stream().map(ClocheRecipe::seed).filter(seed -> seed.test(itemStack)).toList();
